...
const Features = () => {
  ...
  container.innerHTML = `
   ...
   <p class="feature-text">With our integrated CRM, project management, collaboration and invoicing <br> capabilities, you can manage every aspect of your business.</p>
   ...
   <p class="text">General advice on professional practice in conference <br> interpreting, with the aim of.</p>
   </div></div>
   <div class="feature-icon">
   <div class="icon-container">
   <img src="./images/feature-icon-camera.png" class="icon">
   <h2 class="title">Monitor business changes</h2>
   <p class="text">For assessing your change management success. It ease <br> recording and assessing data.</p>
   </div></div>
  <div class="feature-icon">
   <div class="icon-container">
   <img src="./images/feature-icon-bell.png" class="icon">
   <h2 class="title">Full consultation</h2>
   <p class="text">Consultees can take advantage of the full consultation <br>period to prepare considered.</p>
   </div></div>
   </div>
